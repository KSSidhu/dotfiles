-- This progress display is copied from:
-- https://github.com/rockyzhang24/dotfiles/blob/42e0c018c8372243332653a9cdbf303a71fbfdc6/.config/nvim/lua/rockyz/lsp/progress.lua#L88
-- Like that custom built and simple display. Working to fully understand it, but is amazing to read!
...
-- Progress notitifcation is structured as:
-- {
--   method = '$/progress',
--   params =  {
--     token = ...,
...
-- }
--
-- Work progressing beginning is structured as:
-- {
--   kind = 'begin',
--   title = ...,
...
-- }
--
-- Work in progress structured as:
-- {
--   kind = 'report',
--   cancellable = ...,     -- optional
--   message = ...,    -- optional
...
-- }
--
-- Work progress done is structured as:
-- {
--   kind = 'end',
--   message = ...,    -- optional
-- }
